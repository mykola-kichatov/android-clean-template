...
internal fun VersionCatalog.composeMaterialIconsExtended() = getLibrary("compose-material-icons-extended")
...
internal fun VersionCatalog.moshiCodeGen() = getLibrary("moshi-codegen")
internal fun VersionCatalog.retrofit() = getLibrary("retrofit")
internal fun VersionCatalog.retrofitMoshi() = getLibrary("retrofit-moshi")
