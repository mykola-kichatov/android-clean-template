...
@Composable
internal fun SharedTransitionScope.ElementsList(
...
private fun SharedTransitionScope.ElementColumnItem(
    ...
    ListItem(
        ...
        leadingContent = {
            AsyncImage(
                ...
                modifier = Modifier
                    .size(100.dp)
                    .sharedElement(
                        state = rememberSharedContentState(key = item.imageUrl),
                        animatedVisibilityScope = animatedVisibilityScope,
                    ),
        ...
        headlineContent = {
            Text(
                modifier = Modifier.sharedBounds(
                    sharedContentState = rememberSharedContentState(key = item.description),
                    animatedVisibilityScope = animatedVisibilityScope,
                ),
